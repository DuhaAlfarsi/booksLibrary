            ...
            <div class="container">
                ...
                <div class="c2">
                    <form method="POST" action="{{ route('login') }}" class="signin">
                        ...
                        <br><br><br><br>
                        <input value="{{ old('email') }}" name="email" type="email" placeholder="Email*" class="username @error('email') is-invalid @enderror" />
                        @error('email')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                        @enderror
                        <input name="password" type="password" placeholder="Password*" class="username @error('password') is-invalid @enderror" />
                        @error('password')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    ...
                    <form class="signup" method="POST" action="{{ route('register') }}">
                        ...
                        <input name="password_confirmation" type="password" placeholder="Password confirmation*" class="username" />
