              ...
              <div class="col-xl-8 m-auto">
                <div class="card shadow">
                        ...
                        <div class="card-header">
                            <h4 class="card-title font-weight-bold">{{__('Add New Order')}} </h4>
                        </div>
                      ...
                      <div class="card-body ">
                        ...
                        <div class="form-group mb-2">
                            <div class="form-group mb-2">
                                <div class="form-group mb-2">
                                    <label for="user_name"> {{__('User Name')}} <span class="text-danger"> * </span></label>
                            ...
                            <div class="form-group mb-2">
                                <label for="book_name"> {{__('Book Name')}} <span class="text-danger"> * </span></label>
                                    <input type="text" name="book_name" class="form-control" value="{{old('book_name')}}" />
                                    {!!$errors->first("book_name", "<span class='text-danger'>:message</span>")!!}
                            </div>
